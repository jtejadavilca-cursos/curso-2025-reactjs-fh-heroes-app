...
import { useHeroDetailStyles } from "@/heroes/hooks/useHeroDetailStyles";
...
export const HeroPage = () => {
    ...
    if (!idSlug || idSlug.trim().length === 0) return <h1>Hero not found!</h1>;

    const { superheroData, averagePower } = useHeroDetail(idSlug);
    const { getStatusColor, getCategoryColor } = useHeroDetailStyles();
